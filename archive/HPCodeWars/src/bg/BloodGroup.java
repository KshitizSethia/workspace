...
public class BloodGroup {
	...
	public static void main(String[] args) {
		...
		for(int testCaseNumber=1;testCaseNumber<=numTestCases;testCaseNumber++)
		{
			...
			fillBloodGroups(parent1, parent2, child);

			boolean childIsMissing = true;
			...
			{
				fileWriter.write(""/*parent1 bloodGroup*/);
				fileWriter.write(getPossibleBloodGroupsForParent(parent1, child));
