...
phenotypeCardinality=2;	% coz, either the phenotype is expressed or not.
genotypeCardinality=3;	% description (above) says that genotype has 3 values (homo dominant(1), hetero(2) and homo recessive(3))

% Fill in phenotypeFactor.var.  This should be a 1-D row vector.
phenotypeFactor.var = [phenotypeVar, genotypeVar];
% Fill in phenotypeFactor.card.  This should be a 1-D row vector.
phenotypeFactor.card = [phenotypeCardinality, genotypeCardinality];

phenotypeFactor.val = zeros(1, prod(phenotypeFactor.card));
% Replace the zeros in phentoypeFactor.val with the correct values.
phenotypeFactor.val = [isDominant, !isDominant, isDominant, !isDominant, !isDominant, isDominant];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
