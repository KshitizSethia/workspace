...
% patch to reorder factor vars
%A=ReorderFactorVars(A, sort(A.var));
%B=ReorderFactorVars(B, sort(B.var));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
values = (A.val(indxA))(:).*(B.val(indxB))(:);

C = SetValueOfAssignment(C, assignments, values);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
